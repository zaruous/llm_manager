...
/**
 * 로드 탭에서 소스 디렉토리 스캔 결과를 담는 파일/디렉토리 항목 모델.
 * 체크박스 선택 상태를 {@link BooleanProperty}로 관리해 TreeView 셀과 바인딩한다.
 */
public class LoadFileEntry {
    ...
    /** 디렉토리 노드 여부. true이면 미리보기/로드 대상이 아니다. */
    private final boolean directory;

    /** TreeView 체크박스 바인딩용 선택 상태. 기본값 true(스캔 시 전체 선택). */
